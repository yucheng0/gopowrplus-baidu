  ...
  hihi
      ...
      <>
        <Layout>
          ...
          <Layout
          >
            <Sider  md={24} style={{ backgroundColor: 'white' }}>
              <LineChart />
            </Sider>
            <Sider md={24} style={{ backgroundColor: 'blue' }}>
              <PieChart />
            </Sider>
          </Layout>

          {/* <Layout>
            <Sider width="50%" style={{ backgroundColor: 'red' }}
            >
              <StackColumnPlot />
           </Sider>
            <Sider width="50%" style={{ backgroundColor: 'green' }}>
              <PercentStackedArea />
            </Sider>
          </Layout> */}
          ...
          {/* <Layout>
            <Sider width="50%" style={{ backgroundColor: 'yellow' }}
            >
             <TheCausesOfCO2Emissions />
           </Sider>
            <Sider width="50%" style={{ backgroundColor: 'sky' }}>
