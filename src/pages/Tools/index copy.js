  ...
  return (
    <div>
      ...
      <Row style={{ marginTop: 10 }} justify="start">
        ...
        <Col span={7}>
          <Input placeholder="" onChange={ssid24G} />
        </Col>
      ...
      <Row style={{ marginTop: 10 }}>
        ...
        <Col span={7}>
          <Input placeholder="" onChange={pw24G} />
        </Col>
      ...
      <Row style={{ marginTop: 10 }}>
        ...
        <span style={{fontSize:20,position:'relative',top:-2, margin:5}}>.</span>
        <Col span={1}>
          <Input placeholder="" onChange={sgIp} />
        </Col>
        <span style={{fontSize:20,position:'relative',top:-2, margin:5}}>.</span>
      ...
      <Row style={{ marginTop: 10 }}>
        ...
        <Col span={7}>
          <Input placeholder="" onChange={ssid5G} />
        </Col>
      </Row>
      ...
      <Row style={{ marginTop: 10 }}>
        ...
        <Col span={7}>
          <Input placeholder="" onChange={pw5G} />
        </Col>
        {/* <Col span={12}>
          EAP User Password  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          <Input placeholder=""  />
